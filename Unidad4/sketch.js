...
function preload() {
  ...
  sprites[4] = loadImage('spritesheet/Fireball_1_normal_SpriteSheet.png') // 4: Lento 1
  sprites[5] = loadImage('spritesheet/Flame_Vertical_4_SpriteSheet.png') // 5: Lento 2
  sprites[6] = loadImage('spritesheet/Magic_Sphere_normal_SpriteSheet.png') // 6: Lento 3
...
function setup() {
  ...
  let spriteConfigs = [
    ...
    { cols: 2, rows: 2, frames: 4 }, // 4
    { cols: 8, rows: 4, frames: 24 }, // 5
    { cols: 4, rows: 2, frames: 8 }, // 6
  ]
